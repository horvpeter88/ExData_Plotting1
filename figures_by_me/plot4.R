...
par(mfrow=c(2,2))
 with(data2, {plot(Date, Global_active_power, pch="", xlab="", ylab="Global Active Power")
                    lines(Date, Global_active_power, lty=1, col="black")})
 with(data2, {plot(Date, Voltage, pch="", xlab="datetime", ylab="Voltage")
                    lines(Date, Voltage, lty=1, col="black")})
 ...
 with(data2, {plot(Date, Global_reactive_power, pch="", xlab="datetime", ylab="Global_reactive_power")
                     lines(Date, Global_reactive_power, lty=1, col="black")})
